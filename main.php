...
?>
	<div class="item">
		<span href="../mboard/index.php?type_view&table=_notice&num=<?=$num?>&page=1">
		</span>
...
?>
	<div class="item">
		<span class="col1"><a href="../mboard/index.php?type_view&table=_qna&num=<?=$num?>&page=1"><?=$subject ?></a>
		<?php
